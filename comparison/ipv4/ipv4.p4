...
control MyIngress(inout headers hdr,
    ...
    action myTunnel_forward(ip4Addr_t ipv4_srcAddr, ip4Addr_t ipv4_dstAddr, macAddr_t dstAddr, egressSpec_t port) {
        standard_metadata.egress_spec = port;
        hdr.ethernet.srcAddr = hdr.ethernet.dstAddr;
        hdr.ethernet.dstAddr = dstAddr;
        ...
        hdr.ipv4_tunnel.srcAddr = ipv4_srcAddr;
        hdr.ipv4_tunnel.dstAddr = ipv4_dstAddr;
