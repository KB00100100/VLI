...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:72] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[71:0] = hdr.sinet_extend_src_graft1.srcAddr[151:80];
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:72] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[71:0] = hdr.sinet_extend_dst_graft1.dstAddr[151:80];
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    if(hdr.sinet.srcAddr_length >= 184) {
	       ...
	       hdr.sinet_extend_src_graft1.srcAddr[151:80] = meta.sinetAddr_src[71:0];
	       hdr.sinet_extend_src_graft0.setValid();
	       hdr.sinet_extend_src_graft0.next_header = 0x80;
	       hdr.sinet_extend_src_graft0.srcAddr = meta.sinetAddr_src[223:72];
