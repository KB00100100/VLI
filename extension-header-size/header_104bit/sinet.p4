...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:120] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[119:16] = hdr.sinet_extend_src_graft1.srcAddr;
    ...
    state parse_sinet_extend_src_graft2 {
        ...
        //24 bits
        meta.sinetAddr_src[15:0] = hdr.sinet_extend_src_graft2.srcAddr[103:88];
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:120] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[119:16] = hdr.sinet_extend_dst_graft1.dstAddr;
    ...
    state parse_sinet_extend_dst_graft2 {
        ...
        //24 bits
        meta.sinetAddr_dst[15:0] = hdr.sinet_extend_dst_graft2.dstAddr[103:88];
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    if(hdr.sinet.srcAddr_length >= 208) {
