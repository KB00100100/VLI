...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:168] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[167:112] = hdr.sinet_extend_src_graft1.srcAddr;
    ...
    state parse_sinet_extend_src_graft2 {
        ...
        //24 bits
        meta.sinetAddr_src[111:56] = hdr.sinet_extend_src_graft2.srcAddr;
    ...
    state parse_sinet_extend_src_graft3 {
        ...
        //24 bits
        meta.sinetAddr_src[55:0] = hdr.sinet_extend_src_graft3.srcAddr;
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:168] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[167:112] = hdr.sinet_extend_dst_graft1.dstAddr;
    ...
    state parse_sinet_extend_dst_graft2 {
        ...
        //24 bits
        meta.sinetAddr_dst[111:56] = hdr.sinet_extend_dst_graft2.dstAddr;
    ...
    state parse_sinet_extend_dst_graft3 {
        ...
        //24 bits
        meta.sinetAddr_dst[55:0] = hdr.sinet_extend_dst_graft3.dstAddr;
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    if(hdr.sinet.srcAddr_length >= 200) {
	    ...
	    else if(hdr.sinet.srcAddr_length >= 88) {
	       hdr.sinet_extend_src_graft1.setValid();
	       if(hdr.sinet.dstAddr_length >= 32) {
	    ...
	    else if(hdr.sinet.dstAddr_length >= 88) {
	       hdr.sinet_extend_dst_graft1.setValid();
