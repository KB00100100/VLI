...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:136] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[135:48] = hdr.sinet_extend_src_graft1.srcAddr;
    ...
    state parse_sinet_extend_src_graft2 {
        ...
        //24 bits
        meta.sinetAddr_src[47:0] = hdr.sinet_extend_src_graft2.srcAddr[87:40];
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:136] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[135:48] = hdr.sinet_extend_dst_graft1.dstAddr;
    ...
    state parse_sinet_extend_dst_graft2 {
        ...
        //24 bits
        meta.sinetAddr_dst[47:0] = hdr.sinet_extend_dst_graft2.dstAddr[87:40];
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    if(hdr.sinet.srcAddr_length >= 208) {
	       ...
	       hdr.sinet_extend_src_graft2.srcAddr[87:40] = meta.sinetAddr_src[47:0];
	       hdr.sinet_extend_src_graft1.setValid();
	       hdr.sinet_extend_src_graft1.next_header = 0x80;
	       hdr.sinet_extend_src_graft1.srcAddr = meta.sinetAddr_src[135:48];
	       hdr.sinet_extend_src_graft0.setValid();
	       hdr.sinet_extend_src_graft0.next_header = 0x80;
	       hdr.sinet_extend_src_graft0.srcAddr = meta.sinetAddr_src[223:136];
	    ...
	    if(hdr.sinet.dstAddr_length >= 208) {
	       ...
	       hdr.sinet_extend_dst_graft2.dstAddr[87:40] = meta.sinetAddr_dst[47:0];
	       hdr.sinet_extend_dst_graft1.setValid();
	       hdr.sinet_extend_dst_graft1.next_header = 0x90;
	       hdr.sinet_extend_dst_graft1.dstAddr = meta.sinetAddr_dst[135:48];
	       hdr.sinet_extend_dst_graft0.setValid();
	       hdr.sinet_extend_dst_graft0.next_header = 0x90;
	       hdr.sinet_extend_dst_graft0.dstAddr = meta.sinetAddr_dst[223:136];
