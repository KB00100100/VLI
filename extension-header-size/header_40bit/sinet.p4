...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:184] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[183:144] = hdr.sinet_extend_src_graft1.srcAddr;
    ...
    state parse_sinet_extend_src_graft2 {
        ...
        //24 bits
        meta.sinetAddr_src[143:104] = hdr.sinet_extend_src_graft2.srcAddr;
    ...
    state parse_sinet_extend_src_graft3 {
        ...
        //24 bits
        meta.sinetAddr_src[103:64] = hdr.sinet_extend_src_graft3.srcAddr;
    ...
    state parse_sinet_extend_src_graft4 {
        ...
        //24 bits
        meta.sinetAddr_src[63:24] = hdr.sinet_extend_src_graft4.srcAddr;
    ...
    state parse_sinet_extend_src_graft5 {
        ...
        //24 bits
        meta.sinetAddr_src[23:0] = hdr.sinet_extend_src_graft5.srcAddr[39:16];
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:184] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[183:144] = hdr.sinet_extend_dst_graft1.dstAddr;
    ...
    state parse_sinet_extend_dst_graft2 {
        ...
        //24 bits
        meta.sinetAddr_dst[143:104] = hdr.sinet_extend_dst_graft2.dstAddr;
    ...
    state parse_sinet_extend_dst_graft3 {
        ...
        //24 bits
        meta.sinetAddr_dst[103:64] = hdr.sinet_extend_dst_graft3.dstAddr;
    ...
    state parse_sinet_extend_dst_graft4 {
        ...
        //24 bits
        meta.sinetAddr_dst[63:24] = hdr.sinet_extend_dst_graft4.dstAddr;
    ...
    state parse_sinet_extend_dst_graft5 {
        ...
        //24 bits
        meta.sinetAddr_dst[23:0] = hdr.sinet_extend_dst_graft5.dstAddr[39:16];
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    if(hdr.sinet.srcAddr_length >= 232) {
	    ...
	    else if(hdr.sinet.srcAddr_length >= 152) {
	       hdr.sinet_extend_src_graft3.setValid();
	       if(hdr.sinet.dstAddr_length >= 32) {
	    ...
	    else if(hdr.sinet.srcAddr_length >= 112) {
	       hdr.sinet_extend_src_graft2.setValid();
	       if(hdr.sinet.dstAddr_length >= 32) {
	    ...
	    else if(hdr.sinet.srcAddr_length >= 72) {
	       hdr.sinet_extend_src_graft1.setValid();
	       if(hdr.sinet.dstAddr_length >= 32) {
	    ...
	    else if(hdr.sinet.dstAddr_length >= 152) {
	       hdr.sinet_extend_dst_graft3.setValid();
	    ...
	    else if(hdr.sinet.dstAddr_length >= 112) {
	       hdr.sinet_extend_dst_graft2.setValid();
	    ...
	    else if(hdr.sinet.dstAddr_length >= 72) {
	       hdr.sinet_extend_dst_graft1.setValid();
