...
parser BlackBoxParser(packet_in packet,
    ...
    state parse_sinet_extend_src_graft0 {
        ...
        //24 bits
        meta.sinetAddr_src[223:152] = hdr.sinet_extend_src_graft0.srcAddr;
    ...
    state parse_sinet_extend_src_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_src[151:80] = hdr.sinet_extend_src_graft1.srcAddr;
    ...
    state parse_sinet_extend_src_graft2 {
        ...
        //24 bits
        meta.sinetAddr_src[79:8] = hdr.sinet_extend_src_graft2.srcAddr;
    ...
    state parse_sinet_extend_src_graft3 {
        ...
        //24 bits
        meta.sinetAddr_src[7:0] = hdr.sinet_extend_src_graft3.srcAddr[71:64];
    ...
    state parse_sinet_extend_dst_graft0 {
        ...
        //24 bits
        meta.sinetAddr_dst[223:152] = hdr.sinet_extend_dst_graft0.dstAddr;
    ...
    state parse_sinet_extend_dst_graft1 {
        ...
        //24 bits 
        meta.sinetAddr_dst[151:80] = hdr.sinet_extend_dst_graft1.dstAddr;
    ...
    state parse_sinet_extend_dst_graft2 {
        ...
        //24 bits
        meta.sinetAddr_dst[79:8] = hdr.sinet_extend_dst_graft2.dstAddr;
    ...
    state parse_sinet_extend_dst_graft3 {
        ...
        //24 bits
        meta.sinetAddr_dst[7:0] = hdr.sinet_extend_dst_graft3.dstAddr[71:64];
...
control BlackBoxEgress(inout headers hdr,
    ...
    apply {
	    ...
	    else if(hdr.sinet.srcAddr_length >= 104) {
	       hdr.sinet_extend_src_graft1.setValid();
	       if(hdr.sinet.dstAddr_length >= 32) {
	    ...
	    else if(hdr.sinet.dstAddr_length >= 104) {
	       hdr.sinet_extend_dst_graft1.setValid();
